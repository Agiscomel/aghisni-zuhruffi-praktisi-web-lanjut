    ...
    <section class="sidebar">	
      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview">
          <a href="#">
            <i data-feather="message-circle"></i>
            <span>Kelola Handphone</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('user.view')}}"><i class="ti-more"></i>Tampilkan handphone</a></li>
            <li><a href="calendar.html"><i class="ti-more"></i>Tambah handphone</a></li>
          </ul>
        </li> 
        <li class="treeview">
          <a href="#">
