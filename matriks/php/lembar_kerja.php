...
if (isset($_POST["submit"])) { //Menggunakan kondisi if yg didalamnya ada tombol submi dengan method POST 
        ...
        <div class="activity-data">
          ...
          <div class="box">
            ...
            <div class="data type">
              ...
              <span class="data-list"><?php $tanggal = $lmb['tanggal'];
                                      echo date("l-m-Y", strtotime($tanggal)) ?></span>
            </div>
